...
echo '<p><a href="' . home_url('/reels/') . '" target="_blank" style="background: #ff6b6b; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">🎬 Open Reels Archive (With Theme Header)</a></p>';
echo '<p><small>The archive page now includes your theme\'s header, navigation, and footer with a beautiful page title section and centered vertical feed.</small></p>';
