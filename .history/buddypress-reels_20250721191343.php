...
add_shortcode('bpr_reels_feed', function() {
    ...
    <div class="bpr-feed">
        ...
        while ($query->have_posts()) : $query->the_post();
            ...
            // BuddyPress profile URL (fallback to WP author archive)
            ...
            <div class="bpr-video-wrapper">
                ...
                <div class="bpr-overlay">
                    <a href="<?php echo esc_url($profile_url); ?>" class="bpr-author-link" target="_blank" rel="noopener">
